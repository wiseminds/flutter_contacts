...
//          ;
  ...
  void updateContact() async {
    ...
    ninja?.avatar = null;
    if (ninja != null) await ContactsService.updateContact(ninja);
  ...
  void contactOnDeviceHasBeenUpdated(Contact contact) {
    this.setState(() {
      var id =
          _contacts?.indexWhere((c) => c.identifier == contact.identifier) ?? 0;
      if (_contacts?.length != null && _contacts!.length > id) {
